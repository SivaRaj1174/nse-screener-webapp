...
ALL_STOCKS = [s for sub in SECTORS_MAP.values() for s in sub]
...
def run_screener():
    global CACHE
    try:
        data = yf.download(ALL_STOCKS, period="1mo", interval="1d", group_by='ticker', progress=False)
        ...
        print("Screener Execution Error:", e)
