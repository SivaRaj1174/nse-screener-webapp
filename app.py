...
sector_dict = {
    "Nifty Bank - Private": ["KOTAKBANK", "HDFCBANK", "ICICIBANK", "AXISBANK", "INDUSINDBK"],
    "Nifty Bank - PSU": ["SBIN", "BANKBARODA", "CANBK", "UNIONBANK"],
    "IT Services": ["TCS", "INFY", "HCLTECH", "WIPRO", "TECHM"],
    "Automobiles": ["TATAMOTORS", "MARUTI", "M&M", "HEROMOTOCO"],
    "Metals & Mining": ["TATASTEEL", "JINDALSTEL", "HINDALCO", "NMDC", "SAIL", "NATIONALUM", "VEDL"],
    "Agri - Sugar": ["BALRAMCHIN", "RENUKA", "EIDPARRY"],
    "Agri - Fertilizers": ["FACT", "COROMANDEL", "GNFC"]
}
...
def screener_data():
    ...
    for sector, tickers in sector_dict.items():
        ...
        if all_signals:
            ...
            recent_counts = daily_counts.tail(10).iloc[::-1]
